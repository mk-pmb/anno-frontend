...
{ "id": "https://anno.ub.uni-heidelberg.de/123",
  ...
  "body": [
    ...
    { "motivation": "linking", "label": "Metavariables",
...
{ "@context": "http://anno.ub.uni-heidelberg.de/context.jsonld",
  "body": [
    { "format": "text/html", "type": "TextualBody", "value": "",
      "id": "http://anno.ub.uni-heidelberg.de/cgi-bin/anno.cgi" +
        "?id=802168b6-873f-4194-88b2-8e6a29a1493b&body=1&rev=1",
    },
    { "predicate": "", "purpose": "linking", "value": "Mit Titel",
      "source": "http://mit.titel.test/",
    },
    { "predicate": "", "purpose": "linking",
  ...
  "hasVersion": [
    { "modified": "2017-03-31 11:22:27",
      "id": "http://anno.ub.uni-heidelberg.de/cgi-bin/anno.cgi" +
        "?id=802168b6-873f-4194-88b2-8e6a29a1493b&rev=1",
    },
  ],
  "id": "http://anno.ub.uni-heidelberg.de/cgi-bin/anno.cgi" +
    "?id=802168b6-873f-4194-88b2-8e6a29a1493b&rev=1",
  "target": [
    { "id": "http://anno.ub.uni-heidelberg.de/cgi-bin/anno.cgi" +
        "?id=802168b6-873f-4194-88b2-8e6a29a1493b&target=1&rev=1",
      "selector": {
        "type": "SvgSelector",
        "value": "" +
